...
val major = props["revenueCatMajorVersion"].toString().toInt()
val minor = props["revenueCatMinorVersion"].toString().toInt()
val patch = props["revenueCatPatchVersion"].toString().toInt()
...
ext {
    ...
    set("PUBLISH_ARTIFACT_ID", "chipmango-revenue-cat")
